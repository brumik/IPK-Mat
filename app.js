...
server = net.createServer(function (socket) {
    ...
    var tests = ["1 + 1", "2 + 2", "3 - 4", "4 * 4", "9 / 0", "1000 / 2", "2 / 2", "5 / 2" ,"432749865987634387946482736147362498712634 / 2"];
    var results = ["2.00" , "4.00", "-1.00" , "16.00", "ERROR", "500.00", "1.00", "2.50", "ERROR"];
